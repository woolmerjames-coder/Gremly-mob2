  ...
  describe('Todo Round-Trip', () => {
    it('should persist all todo fields across save and reopen', async () => {
      ...
      const updatedFields = {
        ...
        due_time: '14:30',
        tags: ['#work', '#urgent'],
        reminders: [{ id: 'r1', time: '09:00', frequency: 'once' as const }],
        commitment: true,
      ...
      assertField(
        'Todo',
        'reminders',
        [{ id: 'r1', time: '09:00', frequency: 'once' }],
        todoAfter.reminders,
        failures,
      );
  ...
  describe('Habit Round-Trip', () => {
    it('should persist all habit fields across save and reopen', async () => {
      ...
      const updatedFields = {
        ...
        tags: ['#health', '#morning'],
        reminders: [{ id: 'r1', time: '07:00', frequency: 'daily' as const }],
  ...
  describe('Note/Log Round-Trip', () => {
    it('should persist all note fields across save and reopen (journal)', async () => {
      ...
      const updatedFields = {
        ...
        reminders: [{ id: 'r1', time: '21:00', frequency: 'daily' as const }],
        commitment: true,
