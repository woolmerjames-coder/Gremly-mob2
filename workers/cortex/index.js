...
- frequency_type: "stop_quit" overrides exploring frame → When frequency_type is stop_quit, this signal takes precedence over an exploring frame. A user expressing intent to cease a recurring personal behavior has stated a concrete behavioral target, regardless of how tentatively or emotionally they have framed it. The softness of the framing reflects how the user feels about the change, not uncertainty about whether they want to make it. Classify as HABIT/break_habit unless there is explicit evidence that the user is purely processing emotion with no intent to track a change.
